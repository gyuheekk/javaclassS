...
<head>
  ...
  <script>
    ...
    function chartChange() {
    	...
    	else if(part == "line2") {	// 가장 많이 방문한 회원 7명
    		chartShow('line2');
    	}
    	$("#demo").html(str);
    }
  ...
  <div>
    <p>학습할 차트 선택하세요..
      <select name="part" id="part" onchange="chartChange()">
        ...
        <option value="line2" ${vo.part == 'lineChartVisitCount2' ? 'selected' : ''}>많이방문한회원7명</option>
      </select>
    </p>
    <hr/>
    <div id="demo"></div>
    <div>
      ...
      <c:if test="${vo.part = 'barV'}"><jsp:include page="pieChart.jsp" /></c:if>
