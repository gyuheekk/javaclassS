...
<div class="container">
	...
	<div>(생성된 QR코드를 메일로 보내드립니다. QR코드를 입장시 매표소에 게시해 주세요)</div>
	<form name="myform" method="post">
	    <table class="table table-bordered text-center">
	      ...
	      <tr>
	        <th>이메일</th>
	        <td><input type="text" name="email" id="email" value="kh010129@naver.com" required class="form-control"/></td>
	      </tr>
	      <tr>
	        <th>영화명선택</th>
	        <td>
	      ...
	      <tr>
	        ...
	        <td>
	        	<select name="movieTime" id="movieTime" class="form-control">
	        		...
	        		<option>15시 00분</option>
	        		<option>17시 30분</option>
	        		<option>20시 00분</option>
	        		<option>22시 30분</option>
	        	</select>
	        </td>
	      </tr>
	      <tr>
	        ...
	        <td>
	        	...
	        	어린이 <input type="number" name="movieChild" id="movieChild" value="1" min="0" required class="form-control"/>
        	</td>
	      </tr>
	      <tr>
	        <td colspan="2">
