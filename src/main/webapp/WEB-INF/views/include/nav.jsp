  ...
  function kakaoLogout() {
	  ...
	  if(accessToken) {
		  Kakao.Auth.logout(function(){
			  location.href = "https://kauth.kakao.com/oauth/logout?client_id=9f1100921cedf0acc87d10b394a10590&logout_redirect_uri=http://localhost:9090/javaclassS/member/memberLogout";
...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <!-- <a href="http://192.168.50.60:9090/javaclassS/" class="w3-bar-item w3-button w3-padding-large">HOME</a> -->
	    ...
	    <div class="w3-dropdown-hover w3-hide-small">
	      ...
	      <div class="w3-dropdown-content w3-bar-block w3-card-4">
	        ...
	        <a href="${ctp}/study/crawling/selenium" class="w3-bar-item w3-button">크롤링(selenium)</a>
      	 	...
      	 	<a href="${ctp}/calendar/calendar" class="w3-bar-item w3-button">캘린더</a>
	      </div>
	    </div>
	    <div class="w3-dropdown-hover w3-hide-small">
